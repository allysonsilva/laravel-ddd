...
use App\Units\Auth\Services\OneSessionPerUser;
...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        app(UpdateUserLastLogin::class, ['user' => $user])->execute();
        app(OneSessionPerUser::class, ['user' => $user])->execute();
