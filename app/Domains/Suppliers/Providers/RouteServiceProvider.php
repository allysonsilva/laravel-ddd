...
use App\Domains\Suppliers\Console\Closures\ClosureCommands;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = \App\Domains\Suppliers\Http\Controllers::class;
    ...
    protected function mapWebRoutes()
    {
        Route::middleware(['web'])
              ...
              ->group(domain_route_file(self::__DOMAIN, 'WebGuest.php'));
