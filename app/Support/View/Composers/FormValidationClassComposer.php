...
namespace App\Support\View\Composers;

use Illuminate\View\View;
use Illuminate\Http\Request;

class FormValidationClassComposer
{
    /**
    ...
    public function compose(View $view)
    {
        ...
        // Caso a chave {class} exista no array {$attributes} então, a mesma será SUBSTITUÍDA.
        // Caso a chave não existe, será CRIADA/ADICIONADA.
